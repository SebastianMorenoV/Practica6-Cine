...
import mx.edu.itson.myapplication.Pelicula
...
class Catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gridPelis: GridView = findViewById<GridView>(R.id.movies_catalogo)
        var gridSeries: GridView = findViewById<GridView>(R.id.series_catalogo)
        ...
        if (peliculas.isEmpty()) {
            ...
            peliculas.add(
                Pelicula(4,
                    ...
                    R.drawable.heroexencargoheader,
    ...
    fun cargarSeries(){
        if (series.isEmpty()) {
            series.add(Pelicula(7,"Avatar: La leyenda de Aang", R.drawable.aang, R.drawable.aangheader, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego.", arrayListOf<Cliente>()))
            series.add(Pelicula(8,"Halo", R.drawable.halo, R.drawable.halos, "Una evacuación mortal cambia la guerra del Jefe Maestro con el Covenant. En Reach, un nuevo régimen toma el mando en FLEETCOM. John siente una amenaza inminente cerca. Estreno de temporada.", arrayListOf<Cliente>()))
            series.add(Pelicula(9,"Solo Leveling", R.drawable.sololeveling, R.drawable.sololevelingheader, "En un mundo en el que ciertos humanos llamados “cazadores” poseen habilidades mágicas, estos deben luchar contra monstruos para proteger a la raza humana de una aniquilación segura. Un cazador muy débil llamado Sung Jinwoo se encuentra en una lucha en la que solo puede tratar de sobrevivir.", arrayListOf<Cliente>()))
            series.add(Pelicula(10,"Mi adorable demonio", R.drawable.adorabledemonio, R.drawable.adorabledemonioheader, "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.", arrayListOf<Cliente>()))
            series.add(Pelicula(11,"El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.elmonstruoheader, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.", arrayListOf<Cliente>()))
            series.add(Pelicula(12,"The Witcher", R.drawable.thewitcher, R.drawable.thewitcherheader, "Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destiny por un mundo turbulento en el que, a menudo, los humanos son peores que las bestias.", arrayListOf<Cliente>()))
        }
    }
}
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View{
        ...
        var title: TextView = vista.findViewById<TextView>(R.id.movie_title_cell)
